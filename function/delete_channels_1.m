function [eegseizure eeg_data]=delete_channels_1(eegseizure, eeg_data, patient)
    if (patient==12 || patient==13 || patient==14 || patient==15 || patient==16 || patient==17 || patient==18 || patient==19 || patient==20 || patient==21 || patient==22)
        
        if patient==18 || patient==19
            loeschen=[5 10 13 18]
        else 
